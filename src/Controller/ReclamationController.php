...
class ReclamationController extends AbstractController
{
 ...
 #[Route('/recA', name: 'app_reclamation_index1', methods: ['GET'])]
    public function indexA(ReclamationRepository $reclamationRepository): Response
    {
        return $this->render('reclamation/indexA.html.twig', [
            'reclamations' => $reclamationRepository->findAll(),
        ]);
    }
    ...
    public function new(Request $request, ReclamationRepository $reclamationRepository): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            $reclamation->setEtat('non resolved');
    ...
    #[Route('/{id}/editS', name: 'app_reclamation_edit_status', methods: ['GET', 'POST'])]
